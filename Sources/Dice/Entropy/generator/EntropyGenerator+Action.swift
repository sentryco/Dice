...
extension EntropyGenerator {
    ...
    * - Remark: The system may run out of entropy, so be cautious how much you query this method.
    * - Remark: This method essentially traverses through random indices generated by a "crypto-secure-random-generator" method provided by Apple.
    ...
    * - Description: This method generates an array of random strings. The length and character set of the strings can be specified. If the 'unique' parameter is set to true, the method ensures that no character is repeated in the generated strings.
    * - Parameters:
    *   - length: The length of the random string to generate.
    *   - charSet: The characters to include in the random string.
    *   - unique: If true, the generated string will not contain repeated characters.
